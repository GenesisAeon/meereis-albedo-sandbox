  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Sandbox zur Meereis-Albedo-Rückkopplung: Arktis und Antarktis im direkten Vergleich, mit publizierten Zahlen von Duspayev, Zhang und Riihelä.",
      },
